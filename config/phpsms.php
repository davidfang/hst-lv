...
return [
    ...
    'agents' => [
        ...
        'Alidayu' => [
            ...
            'appKey'            => env('ALIDAYU_APP_KEY','your_app_key'),
            //淘宝开放平台中，对应阿里大鱼短信应用的App Secret
            'secretKey'         => env('ALIDAYU_SECRET_KEY','your_secret_key'),
            //短信签名，传入的短信签名必须是在阿里大鱼“管理中心-短信签名管理”中的可用签名
            'smsFreeSignName'   => env('ALIDAYU_SMS_FREE_SIGN_NAME','your_sms_free_sign_name'),
