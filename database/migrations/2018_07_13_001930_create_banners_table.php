...
class CreateBannersTable extends Migration {
	...
	public function up()
	{
		Schema::create('banners', function(Blueprint $table)
		{
			...
			$table->enum('type', array('swiper','recommend'))->nullable()->default('swiper')->comment('类别');
			...
			$table->enum('nav', array('SearchScreen','WebScreen','ChannelScreen','DetailScreen'))->nullable()->default('WebScreen')->comment('NAV类型');
